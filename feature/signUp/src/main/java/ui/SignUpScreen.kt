...
import com.example.signin.presentation.SignUpIntent
import com.example.signin.presentation.SignUpViewModel
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { signInViewModel.handle(SignUpIntent.ChangeUserConfirmPassword(it)) },
                    label = {
                        Text(
                            "Confirm password",
                            color = MaterialTheme.colorScheme.primary
